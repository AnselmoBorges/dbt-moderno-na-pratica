...
const decks = [
  {
    ...
    sections: [
      ...
      { title: "Explore a cópia do banco no navegador", claim: "DuckDB UI abre na porta privada 4213 sem bloquear nem modificar o banco usado pelo dbt.", bullets: ["Execute depois do checkpoint", "Mantenha o terminal aberto", "Ctrl+C encerra e permite atualizar"], visual: "flow", labels: ["dbt build", "snapshot", "DuckDB UI", "navegador"] },
    ],
    demo: { command: "python course.py paths\npython course.py checkpoint 01\npython course.py data-ui", observe: ["dbt e DuckDB do ambiente isolado", "Seeds e artifacts executados", "DuckDB UI na porta privada 4213"], result: "Checkpoint 01 OK + exploração gráfica opcional" },
