...
const decks = [
  {
    ...
    sections: [
      ...
      { title: "Explore a cópia do banco no navegador", claim: "O explorador autoral abre na porta privada 4213 sem modificar o banco usado pelo dbt.", bullets: ["Snapshot somente leitura", "Mantenha o terminal aberto", "Ctrl+C encerra e permite atualizar"], visual: "flow", labels: ["dbt build", "snapshot", "explorador", "navegador"] },
    ],
